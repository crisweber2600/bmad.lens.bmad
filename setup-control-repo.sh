...
echo ""
echo -e "  1. Open this repo in your IDE and start a chat with ${CYAN}@lens${RESET}"
echo -e "  2. Type ${CYAN}/onboard${RESET} to register yourself and configure the workspace"
echo -e "  3. Type ${CYAN}/init${RESET} to create your first initiative"
echo ""
echo -e "New to LENS? Read the getting started guide:"
echo -e "  ${CYAN}./_bmad/lens-work/docs/GETTING-STARTED.md${RESET}"
echo ""
